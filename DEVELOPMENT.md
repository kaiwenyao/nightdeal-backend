...
- REST API 和 `/room` Socket.IO 命名空间双通道房间同步
...
权威规则与协议见 GitHub：[`docs/AVALON-DEVELOPMENT.md`](https://github.com/kaiwenyao/nightdeal-backend/blob/docs/avalon-development/docs/AVALON-DEVELOPMENT.md)。
...
| `room:error` | WebSocket 错误事件；被踢时 code 为 `KICKED` |
